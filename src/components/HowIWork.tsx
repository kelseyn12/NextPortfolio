...
export default function HowIWork() {
  const steps = [
    ...
    { number: 3, title: 'Make', text: 'I do the work in clear phases and keep you in the loop. For custom builds, I use modern tools — including AI — to move fast, then review and refine everything by hand so it actually works the way it should.' },
  ...
  return (
    <section id="how-i-work" className="relative isolate -mt-20 overflow-hidden px-6 py-20 md:-mt-24 md:py-24">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 85% 75% at 50% 50%, rgba(242,237,228,0.6) 0%, rgba(232,224,212,0.2) 55%, transparent 100%)',
        }}
      />
      ...
      <ScrollReveal className="relative z-10 mx-auto max-w-3xl pr-0 pl-[8%] md:pl-[12%]">
        ...
        <div className="space-y-0">
          {steps.map((step, idx) => (
            <ScrollReveal key={step.number} staggerIndex={idx}>
              <div className="flex gap-5 border-b border-steel/12 py-12 last:border-0 last:pb-0 md:gap-6 md:py-14">
                ...
                <div>
                  ...
                  <p className="max-w-2xl leading-loose text-steel">{step.text}</p>
                </div>
              </div>
            </ScrollReveal>
          ))}
